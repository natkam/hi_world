...
if __name__ == "__main__":
    ...
    # b = [
    #     1, 3, 4, 5, 6, 8, 10, 12, 17, 21, 23, 28, 32, 34, 39, 43, 48, 52, 54, 59, 63, 68,
    #     72, 74, 79, 83, 98, 99, 101, 110, 114, 121, 125, 132, 136, 139, 143, 145, 152,
    #     161, 165, 172, 176, 187, 192, 196, 201, 205, 212, 216, 223, 227, 232, 234, 236,
    #     243, 247, 252, 256, 258,
    # ]

    start = time.perf_counter()
    [ulam_sequence(1, 3, 60) for _ in range(1000)]  # ca. 3.3 second
    print(
        f"----- ulam_sequence(1, 3, 60): {(time.perf_counter() - start)} seconds (1000 times) -----"
    )
    start = time.perf_counter()
    ulam_sequence(1, 2, 1500)  # ca. 3.2 second
    print(
